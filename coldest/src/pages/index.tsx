    ...
    <>
      <div>
        <Head>
          ...
          />
          <meta property="og:image" content="/coldest-website/og.png" />
          <meta property="twitter:card" content="summary_large_image" />
          <meta property="twitter:image" content="/coldest-website/og.png" />
          <link
            rel="apple-touch-icon"
            sizes="180x180"
            href="/coldest-website/apple-touch-icon.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="32x32"
            href="/coldest-website/favicon-32x32.png"
          />
          <link
            rel="icon"
            type="image/png"
            sizes="16x16"
            href="/coldest-website/favicon-16x16.png"
          />
          <link rel="manifest" href="/coldest-website/site.webmanifest" />
        </Head>
      </div>
      <main
